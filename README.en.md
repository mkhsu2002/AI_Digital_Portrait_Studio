...
- **Credit management** – New accounts start with 100 free generations; sharing on Facebook can reward an additional credit (configurable).
...
> The default `main` branch limits each account to 100 free generations. If you need unlimited usage, deploy from the `unlimited_v3.0` branch.
